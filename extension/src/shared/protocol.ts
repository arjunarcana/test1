...
export const MSG = {
  ...
  OFFSCREEN_START_MIC: 'OFFSCREEN_START_MIC',
  OFFSCREEN_START_TAB: 'OFFSCREEN_START_TAB',
  OFFSCREEN_STOP: 'OFFSCREEN_STOP',
  OFFSCREEN_AUDIO_CHUNK: 'OFFSCREEN_AUDIO_CHUNK',
  OFFSCREEN_TRANSCRIPT_PARTIAL: 'OFFSCREEN_TRANSCRIPT_PARTIAL',
  OFFSCREEN_TRANSCRIPT_FINAL: 'OFFSCREEN_TRANSCRIPT_FINAL',
  OFFSCREEN_SPEECH_ERROR: 'OFFSCREEN_SPEECH_ERROR',
} as const;
